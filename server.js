...
const SERVER = window.location.origin;
  ...
  'يلتزم المستأجر بدفع كامل مبلغ الإيجار إضافة إلى مبلغ تأمين قدره 100 د.ك، ويعاد التأمين خلال 24 ساعة بعد المعاينة، مع أحقية المؤجر بخصم أي أضرار أو تنظيف إضافي.',
  'الحد الأقصى المسموح به داخل الشاليه هو 8 أشخاص وعاملتين فقط،اجمالي 10 اشخاص فقط، ويمنع إدخال أي أشخاص غير مذكورين في بيانات الحجز..',
  ...
  'يمنع دخول المسبح مع وجود رمل أو أتربة على الجسم، ويجب أخذ شاور قبل السباحة، كما يُمنع النزول إلى المسبح مع وجود زيوت التان على الجسم.',
  'يمنع إدخال طاولات البوفيه وسخانات الطعام ومعدات الضيافة إلى داخل الشاليه، كما يُمنع نقل الأثاث من مكانه أو إعادة توزيعه.',
  ...
  'يحق للمؤجر رفض الدخول أو إنهاء الحجز فوراً عند مخالفة الشروط أو تجاوز العدد المسموح أو الإزعاج أو عدم دفع كامل المبلغ ويسقط حق المطالبة بالمبلغ المدفوع، كما يمنع تأجير الشاليه من الباطن أو التنازل عنه للغير.'
];
